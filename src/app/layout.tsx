...
const NAV = [
  ...
  { href: '/chatbot', label: 'Chatbot', icon: 'M3 4h18v16H3z M9 12a1.5 1.5 0 100-3 1.5 1.5 0 000 3z M15 12a1.5 1.5 0 100-3 1.5 1.5 0 000 3z M12 16c1.5 0 2.5-.8 3-2 M9 16c-1.5 0-2.5-.8-3-2' },
