...
export default function TemplatesPage() {
  ...
  const syncFromMeta = async () => {
    ...
    try {
      ...
      if (d.success) notify(`Synced ${d.synced} templates!`);
      else notify(d.error || "Sync failed. Check WhatsApp API credentials.", "error");
      fetchData();
    ...
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button className="btn btn-secondary" onClick={syncFromMeta}>
